...
void AGGJ21Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AGGJ21Character::OnResetVR);
...
void AGGJ21Character::OnFire()
{
	...
	if (ProjectileClass != NULL)
	{
		...
		if (World != NULL)
		{
			...
			// 	World->SpawnActor<AGGJ21Projectile>(ProjectileClass, SpawnLocation, SpawnRotation);
			// }
			// else
			// {
...
// void AGGJ21Character::OnResetVR()
// {
// 	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
// }

// void AGGJ21Character::BeginTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
// {
...
// }
//
// void AGGJ21Character::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
// {
...
//void AGGJ21Character::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
//{
...
// 	{
// 		PlayerInputComponent->BindTouch(EInputEvent::IE_Pressed, this, &AGGJ21Character::BeginTouch);
// 		PlayerInputComponent->BindTouch(EInputEvent::IE_Released, this, &AGGJ21Character::EndTouch);
//
// 		//Commenting this out to be more consistent with FPS BP template.
// 		//PlayerInputComponent->BindTouch(EInputEvent::IE_Repeat, this, &AGGJ21Character::TouchUpdate);
// 		return true;
// 	}
// 	
// 	return false;
